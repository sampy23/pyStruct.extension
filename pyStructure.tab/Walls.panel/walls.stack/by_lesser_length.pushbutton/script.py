...
param_equality = DB.FilterNumericLessOrEqual() #lesser than equality class
...
if num_walls >= 1:
    ...
    forms.alert("{} Walls of length lesser than {} m selected!!!".format(num_walls,length_m))
else:
    forms.alert("No other walls of length lesser than {} m found!!!".format(length_m))
